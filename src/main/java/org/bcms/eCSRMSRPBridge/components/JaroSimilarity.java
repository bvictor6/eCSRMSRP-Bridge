...
* Date:   Aug 1, 2024
*/
package org.bcms.eCSRMSRPBridge.components;

import org.springframework.stereotype.Component;

/**
 * 1 means the strings are equal, 0 means no similarity at all between the strings
 */
@Component
public class JaroSimilarity {
	...
	public double jaro_distance(String s1, String s2)
	{
